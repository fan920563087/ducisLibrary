...
import com.common.ducis.conmonutil.MobileInfoUtils
import com.common.ducis.conmonutil.MyLog
import com.common.ducis.network.AppServerApi
import com.common.ducis.network.MBaseObserver
import com.common.ducis.network.MNetWorkUtils
...
//        }
     ...
     * @return 返回文件名称
     */
    private fun dumpExceptionToSDCard(e: Throwable): ExceptionBean {
        val sw = StringWriter()
