package com.common.ducis.permission
...
import com.common.ducis.baseview.DefaultPopupWindow
import com.common.ducis.baseview.DefaultPopupWindow.OnSelectedResultListener
...
internal class AcpManager(private val mContext: Context) {
    ...
    private fun showRationalDialog(permissions: Array<String>) {
        ...
        popupWindow.setOnClickResultListener(object : OnSelectedResultListener {
